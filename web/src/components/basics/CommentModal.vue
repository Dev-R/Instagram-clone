<template>
      <div
          ...
          :class="{ 'hidden': !postComment.isToggled }">
            ...
            <!-- Modal Header -->
            <!-- <div class="md:mr-12 flex items-center justify-between md:visible invisible cursor-pointer sm:block hidden">
                <span class="ml-auto inline-flex text-white">
                    <SVGLoader :icon="'cross'" @click="onModalClosed()" />
                </span>
            </div> -->

            <!-- <div class="flex justify-between block sm:hidden cursor-pointer bg-black w-full p-3 border-b border-gray-700">
                        ...
                        <div 
                            ...
                            sm:border-l border-slate-800 sm:p-2">
                              ...
                              <div class="flex flex-col sm:space-x-1 justify-between sm:p-2">
                                ...
                                <div class="flex justify-between border-b border-slate-800 sm:block hidden">
                                  ...
                                  <div class="flex justify-between border-b border-t border-slate-700 bg-slate-1100 p-2.5 space-x-4 block sm:hidden">
                              ...
                              <div 
                                  class="lg:max-h-[600px] min-h-screen sm:max-h-[211px] grid 
                              ...
                              <!-- 3: Comment Actions -->
                              <div class="flex justify-between p-2 border-t border-slate-800 sm:block hidden">
                              ...
                              <div class="flex flex-col space-y-2 space-x-2 sm:block hidden">
                                  <span 
                              ...
                              <div class="grid grid-cols-12 border-t border-slate-800 p-2 sm:block hidden">

            ...
            <div class="grid grid-cols-12">
                ...
                <div class="col-span-2 p-4 bg-black md:block hidden space-y-12 relative h-screen sticky top-0 border-r border-gray-900">
                    ...
                    <div class="flex flex-col space-y-4 flex-nowrap sticky top-0">
                        <!-- A -->
                        <div class="p-4 rounded-lg flex cursor-pointer">
                            <svg aria-label="Instagram" class="" color="rgb(245, 245, 245)" fill="rgb(245, 245, 245)"
                        ...
                        <div class="p-1 flex flex-col space-y-2">
                            <div class="group cursor-pointer rounded-full flex space-x-4 hover:bg-slate-1000 hover:delay-100 hover:delay-100 p-3">
                            ...
                            <div class="group cursor-pointer rounded-full flex space-x-4 hover:bg-slate-1000 hover:delay-100 p-3">
                                ...
                                <span class="font-sans text-md font-normal text-white">
                                    Search
                                </span>
                            </div>
                            <div class="group cursor-pointer rounded-full flex space-x-4 hover:bg-slate-1000 hover:delay-100 p-3">
                            ...
                            <div class="group cursor-pointer rounded-full flex space-x-4 hover:bg-slate-1000 hover:delay-100 p-3">
                                ...
                                <span class="font-sans text-md font-light text-white">
                                    Create
                                </span>
                            </div>
                            <div class="group cursor-pointer rounded-full flex space-x-4 hover:bg-slate-1000 hover:delay-100 p-3">
